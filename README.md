...
## Embedded System & IoT
* **Embedded System:** ESP32, Embedded C/C++
* **IoT Communication:** MQTT, JSON-based telemetry
* **Cloud Monitoring:** ThingsBoard
...
*Note: Each bay is maintained as an independent PlatformIO project.*
...
Screenshots of the project are provided in the repository under: `docs/images/`
...
* **BAY1:** `BAY1/esp32_blink`
* **BAY2:** `BAY2/esp32_blink`
* **BAY3:** `BAY3/esp32_blink`

### Steps:
1. Open the required bay project in Visual Studio Code.
2. Make sure the PlatformIO extension is installed.
3. Open the project.
4. Configure your own credentials locally.
5. Build and run the project.
6. Run the corresponding Wokwi simulation.
7. Monitor the telemetry and charging information through ThingsBoard.
